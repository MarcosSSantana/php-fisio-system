...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="<?= ROOT ?>" class="h1"><b><?= SITE ?></b></a>
        </div>
        <div class="card-body">
<!--            <p class="login-box-msg">Sign in to start your session</p>-->

            <form action="<?= ROOT ?>/paciente" method="get">
...
<!--            <p class="mb-1">-->
<!--                <a href="--><?//= ROOT ?><!--">I forgot my password</a>-->
<!--            </p>-->
<!--            <p class="mb-0">-->
<!--                <a href="--><?//= ROOT ?><!--" class="text-center">Register a new membership</a>-->
<!--            </p>-->
        </div>
        <!-- /.card-body -->
    </div>

                ...
                <div class="card card-lightblue card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link lista" id="tabs-lista-tab" data-toggle="pill" href="#lista" role="tab" aria-controls="tabs-lista" aria-selected="true">Lista</a>
                            </li>
                            <li class="nav-item">
                                <a class="active nav-link cadastro" id="tabs-cadastro-tab" data-toggle="pill" href="#cadastro" role="tab" aria-controls="tabs-cadastro" aria-selected="false">Cadastro</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="example1" name="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($this->data["sessoes"] as $item) { ?>
                                            <tr>
                                                <td><?= $item['id'] ?></td>
                                                <td><?= date_format(date_create($item['dataSessao']), "d/m/Y") ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button class="btn btn-warning btn-sm" onclick="carregar_dados('sessao/dados/<?= $item['id'] ?>')">
                                                            <i class="fas fa-pencil-alt"></i>
                                                            Editar
                                                        </button>

                                                        <a class="btn btn-danger btn-sm deletar_dados" href="sessao/deletar/<?= $item['id'] ?>">
                                                            <i class="fas fa-trash">
                                                            </i>
                                                            Delete
                                                        </a>
                                                        <a class="btn btn-info btn-sm" href="paciente/sessoes/<?= $item['idPaciente'] ?>">
                                                            <i class="fas fa-pencil-alt"></i>
                                                            Ficha
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="pa" placeholder="PA" data-inputmask='"mask": "99[9]x99[9]mmHg"' data-mask>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="fc" placeholder="FC" data-inputmask='"mask": "99[9]bpm"' data-mask>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="sp" placeholder="SP" data-inputmask='"mask": "99[9]%"' data-mask>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
